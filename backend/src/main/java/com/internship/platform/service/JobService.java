...
public class JobService {
    ...
    public JobDto.Response create(JobDto.Request req) {
        ...
        j.setStipend(req.getStipend());
        j.setDurationWeeks(req.getDurationWeeks());
    ...
    public JobDto.Response update(Long id, JobDto.Request req) {
        ...
        if (req.getStipend() != null) j.setStipend(req.getStipend());
        if (req.getDurationWeeks() != null) j.setDurationWeeks(req.getDurationWeeks());
    ...
    public static JobDto.Response toResponse(JobPosting j, double score) {
        ...
        r.setCompanyName(j.getCompany().getName());
        ...
        r.setStipend(j.getStipend());
        r.setDurationWeeks(j.getDurationWeeks());
